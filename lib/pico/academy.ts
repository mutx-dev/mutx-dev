...
export const PICO_PLAN_MATRIX: Record<PicoPlan, Record<PicoPlanFeature, string>> = {
  free: {
    academy: 'Learn the system with full academy access',
    tutor: 'Get grounded help with light daily usage',
    project_limit: 'Run 1 active project lane',
    monitored_agents: 'Preview live control before you trust it',
    alerts: 'Know when something breaks inside Pico',
    approvals: 'See how risky actions get stopped',
    retention: 'Understand what happened for 7 days',
  },
  starter: {
    academy: 'Keep full academy access',
    tutor: 'Get faster tutor routing when you are blocked',
    project_limit: 'Run 3 active project lanes',
    monitored_agents: 'Watch 1 live agent',
    alerts: 'Know when something breaks by email too',
    approvals: 'Prevent bad actions with 1 approval gate',
    retention: 'Understand what happened for 30 days',
  },
  pro: {
    academy: 'Keep full academy access',
    tutor: 'Get faster tutor routing when the stakes are real',
    project_limit: 'Run as many project lanes as you need',
    monitored_agents: 'Watch multiple live agents',
    alerts: 'Know when something breaks across every route',
    approvals: 'Prevent bad actions across multiple gates',
    retention: 'Understand what happened for 90 days',
  },
}
