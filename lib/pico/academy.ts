...
export const PICO_LESSONS: PicoLesson[] = [
  {
    ...
    summary: 'Install Hermes, lock one provider path, and prove the local binary is usable.',
    level: 0,
    track: 'first-agent',
    estimatedMinutes: 15,
    difficulty: 'setup',
    objective: 'Install Hermes and finish exactly one working local provider setup.',
    prerequisites: [],
    outcome: 'A working local Hermes install with one usable provider path.',
    expectedResult: 'You can run `hermes` from a fresh shell and the CLI opens with a real model path configured.',
  ...
  },
  {
    ...
    summary: 'Send one real prompt through Hermes and keep a reusable transcript instead of a vague memory.',
    level: 0,
    track: 'first-agent',
    estimatedMinutes: 15,
    difficulty: 'setup',
    ...
    expectedResult: 'Hermes answers a real prompt and you keep the prompt plus output in a file or note.',
    validation: 'Run one bounded prompt and save both the prompt and the answer in a note or file you can reopen later.',
    xp: 60,
