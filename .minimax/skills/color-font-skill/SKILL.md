...
description: "Use this skill any time to pick a color palette, font-family for PPT or design projects. TRIGGERS: 配色, 色板, 字体, color palette, font, PPT配色, 字体搭配."
---
...
**所有 PPT 和设计项目必须严格遵守以下字体规范：**

| 语言 | 字体 | 备注 |
|------|------|------|
| **中文** | Times New Roman | 标题、正文统一使用 |
| **英文** | Times New Roman | 标题、正文统一使用 |

- 不允许使用其他字体
- 中英文混排时：统一使用 Times New Roman
- `font-family` 写法：`"Times New Roman", serif`
