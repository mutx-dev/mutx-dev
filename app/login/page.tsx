...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (emailValidation || !password) return
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          <div className="text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-cyan-400/10 transition-transform hover:scale-105">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-5 rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 backdrop-blur-xl">
              {(error || emailError) && (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-1.5 relative">
                    ...
                    <input
                      ...
                      className={`block w-full rounded-xl border bg-black/20 py-3 pl-12 pr-4 text-white placeholder-slate-500 transition-all focus:outline-none focus:ring-2 ${
                ...
                <div>
                  ...
                  <div className="mt-1.5 relative">
                    ...
                    <input
                      ...
                      className="block w-full rounded-xl border border-white/10 bg-black/20 py-3 pl-12 pr-12 text-white placeholder-slate-500 transition-all focus:border-cyan-400/50 focus:outline-none focus:ring-2 focus:ring-cyan-400/20"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 rounded border-white/20 bg-black/20 text-cyan-400 focus:ring-cyan-400/20 focus:ring-offset-0"
                  />
