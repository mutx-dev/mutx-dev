  ...
  const renderContent = () => {
    ...
    return (
      <div className="flex items-center justify-center py-20">
        <p className="text-slate-400">Select a page from the sidebar</p>
      </div>
    );
      </>
    );
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#030307] text-slate-100">
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
          <aside className="panel sticky top-16 hidden h-fit rounded-[24px] border border-white/5 bg-white/[0.01] p-5 backdrop-blur-xl lg:min-h-[calc(100vh-2rem)] lg:block">
