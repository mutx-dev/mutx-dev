...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('OPENAI', 'ANTHROPIC', 'LANGCHAIN', 'CUSTOM', name='agenttype'), nullable=False),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('agent_id', sa.UUID(), nullable=False),
    sa.Column('type', sa.Enum('CPU_HIGH', 'MEMORY_HIGH', 'AGENT_DOWN', 'DEPLOYMENT_FAILED', 'QUOTA_EXCEEDED', name='alerttype'), nullable=False),
    sa.Column('message', sa.Text(), nullable=False),
