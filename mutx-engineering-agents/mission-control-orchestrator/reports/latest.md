...
## Control brief — 2026-03-28 19:45 Europe/Rome
...
- PR #1202 is no longer the active auth target; PR #1211 supersedes it in the live review queue.
...
- The newer auth PR (#1211) replaces the older duplicate auth target (#1202) as the active review item.
