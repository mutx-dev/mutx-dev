...
export const picoClasses = {
  ...
  primaryButton: 'inline-flex min-h-11 w-full max-w-full items-center justify-center gap-2 border border-[color:var(--pico-accent)] bg-[color:var(--pico-accent)] px-4 py-3 text-center font-[family:var(--font-mono)] text-[11px] font-semibold uppercase tracking-[.08em] text-[color:var(--pico-accent-contrast)] transition sm:w-auto hover:bg-[color:var(--pico-text)]',
  secondaryButton: 'inline-flex min-h-11 w-full max-w-full items-center justify-center gap-2 border border-[color:var(--pico-border)] bg-transparent px-4 py-3 text-center font-[family:var(--font-mono)] text-[11px] font-semibold uppercase tracking-[.08em] text-[color:var(--pico-text)] transition sm:w-auto hover:border-[color:var(--pico-accent)] hover:text-[color:var(--pico-accent)]',
  tertiaryButton: 'inline-flex min-h-11 w-full max-w-full items-center justify-center gap-2 border border-[color:var(--pico-border)] bg-transparent px-3.5 py-2.5 text-center text-sm text-[color:var(--pico-text-secondary)] transition sm:w-auto hover:text-[color:var(--pico-accent)]',
  ...
  link: 'inline-flex min-h-11 min-w-11 items-center text-sm font-medium text-[color:var(--pico-accent)] transition hover:text-[color:var(--pico-text)]',
