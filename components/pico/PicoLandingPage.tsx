          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                We are not accepting product access at the moment. If you want first access when
                Pico reopens, pre-register here and we will invite people in controlled waves.
              </p>
