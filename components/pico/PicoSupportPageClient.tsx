...
type SupportFormIntent = {
  interest: 'fixing-existing' | 'other'
  source: 'pico-support' | 'pico-office-hours'
}
...
export function PicoSupportPageClient() {
  ...
  const [intent, setIntent] = useState<SupportFormIntent>({
    interest: 'fixing-existing',
    source: 'pico-support',
  })

  function openEscalation(nextIntent: SupportFormIntent) {
      ...
      <PicoShell
        ...
        actions={
          <div className="flex flex-wrap gap-3">
            ...
            <button
              type="button"
              onClick={() => openEscalation({ interest: 'fixing-existing', source: 'pico-support' })}
          ...
          <div className="space-y-6">
            <div className="rounded-[28px] border border-white/10 bg-[rgba(8,15,28,0.82)] p-6 shadow-[0_24px_80px_rgba(2,8,23,0.25)]">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <button
                  type="button"
                  onClick={() => openEscalation({ interest: 'other', source: 'pico-office-hours' })}
