    ...
    >
      <div className="mx-auto max-w-[var(--pico-shell,72rem)]">
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
          <Link
            href="/pico"
            className="inline-flex min-h-11 items-center gap-2 text-sm text-[color:var(--pico-text-secondary)] no-underline transition hover:text-[color:var(--pico-text)]"
          >
          ...
          <a
            href={`${SITE}/releases`}
            className="inline-flex min-h-11 items-center text-sm text-[color:var(--pico-text-muted)] no-underline transition hover:text-[color:var(--pico-text-secondary)]"
          >
            Releases
          </a>
          <a
