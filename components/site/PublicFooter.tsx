        ...
        {showCallout ? (
          <div className="grid gap-6 border-b border-[rgba(233,241,232,0.12)] px-5 py-7 lg:grid-cols-[minmax(0,1.2fr)_auto] lg:items-end lg:px-8 lg:py-9">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 font-[family:var(--font-site-display)] text-[clamp(2.25rem,4vw,4.25rem)] font-semibold leading-[0.9] tracking-[-0.075em] text-[#e9f1e8]">
