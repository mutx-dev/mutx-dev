...
| "Governance — Prometheus metrics export via `/v1/governance/metrics`" | surfaces.md | `/v1/governance/metrics` does not exist. Actual route is `/v1/runtime/governance/metrics` (confirmed in OpenAPI). surfaces.md URL is incorrect. | MISLEADING |
