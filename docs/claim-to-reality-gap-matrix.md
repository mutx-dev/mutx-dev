...
| "Governance — Prometheus metrics export via `/v1/runtime/governance/metrics`" | surfaces.md | `/metrics` at root confirmed in OpenAPI; `/v1/runtime/governance/metrics` NOT present in OpenAPI | MISLEADING |
