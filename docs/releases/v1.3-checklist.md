...
| GitBook sync | `area:docs` | `https://docs.mutx.dev/docs/releases/v1.3` is reachable after merge |
...
2. Confirm `docs/releases/v1.3.md` is merged, `https://docs.mutx.dev/docs/releases/v1.3` is live, and `https://mutx.dev/releases` reflects the same release.
